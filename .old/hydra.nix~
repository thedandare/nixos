...

{
  ...
  options = {
    ...
    services.hydra = {
      ...
      #         '';
      #       };
      #             The option `services.hydra.enable' in `/nix/store/(...)/continuous-integration/hydra/default.nix' is already declared
      ...
      mkDefault (
        if pkgs ? hydra then
          throw ''
            ...
            [1] https://github.com/NixOS/hydra/pull/711
          ''
        else if versionOlder stateVersion "20.03" then
          hydra-migration
        else
          hydra-unstable
      );
